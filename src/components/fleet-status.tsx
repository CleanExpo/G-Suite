...
export function FleetStatus() {
    ...
    return (
        <div className="bg-white dark:bg-[#161b22] p-12 rounded-[4rem] border border-gray-100 dark:border-white/5 shadow-sm space-y-10">
            <div>
                <h3 className="text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-[0.3em] mb-4">Fleet Operational Status</h3>
                <h2 className="text-4xl font-black italic uppercase tracking-tighter text-gray-900 dark:text-white leading-none">System Readiness</h2>
            </div>
