    ...
    return (
        <div className="p-12 rounded-[4rem] bg-gray-900 border border-white/10 relative overflow-hidden group shadow-2xl">
            <div className="relative z-10 space-y-10">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-black text-white uppercase italic tracking-tighter">Mission Simulator</h3>
                            <p className="text-[10px] font-black uppercase tracking-widest text-gray-500">Orchestrator v4.2 Preview</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/5">
                    {[
                        ...
                        <div key={i} className="text-center space-y-2">
                            <div className="flex justify-center"><s.icon className="w-3 h-3 text-gray-500" /></div>
                            <div className="text-[8px] font-black uppercase tracking-widest text-gray-500">{s.label}</div>
            ...
            <div className="absolute inset-0 opacity-10 pointer-events-none">
                <div className="absolute inset-0" style={{ backgroundImage: "radial-gradient(circle, #2563eb 1px, transparent 1px)", backgroundSize: "20px 20px" }} />
            </div>
        </div>
    );
}
