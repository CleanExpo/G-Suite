      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        ...
        <div className="col-span-1 md:col-span-1 space-y-8">
          ...
          <p className="text-gray-500 dark:text-gray-500 text-sm leading-relaxed italic">
            "Orchestrating the future of autonomous agent intelligence. Built for world-class
            founders and the teams that support them."
          </p>
          <div className="flex gap-4">
            <Link
              href="#"
              className="p-2 rounded-xl bg-gray-50 dark:bg-white/5 text-gray-400 hover:text-blue-600 transition-colors"
            >
        ...
        {/* Links Columns */}
        <div>
          <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-gray-400 mb-8 underline decoration-blue-600/30 underline-offset-8">
            Platform
          </h4>
          <ul className="space-y-4 text-sm font-medium text-gray-600 dark:text-gray-400">
            ...
            <li>
              <Link href="/platform/security" className="hover:text-blue-600 transition-colors">
                Vault Security
              </Link>
            </li>
            <li>
              <Link
                href="/abilities"
                className="hover:text-blue-600 transition-colors italic font-bold"
              >
                Codex
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium text-gray-600 dark:text-gray-400">
            <li>
              <Link href="/solutions/agents" className="hover:text-blue-600 transition-colors">
                Agent Fleets
              </Link>
            </li>
            <li>
              <Link href="/solutions/workflows" className="hover:text-blue-600 transition-colors">
                Smarter Workflows
              </Link>
            </li>
            <li>
              <Link href="/intel" className="hover:text-blue-600 transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium text-gray-600 dark:text-gray-400">
            ...
            <li>
              ...
              >
                Google TOS <ExternalLink className="w-3 h-3" />
              </Link>
            </li>
          </ul>
        </div>
