            ...
            <div className="max-w-[1600px] mx-auto h-full px-12 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-6 group">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs uppercase tracking-[0.5em] text-blue-600 dark:text-blue-400 font-black mt-1">Algorithm Dominance Node</span>
                    </div>
                </Link>
                ...
                <div className="flex items-center gap-6">
                    <div className="hidden sm:flex items-center gap-3 px-4 py-2 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-500 transition-all hover:border-blue-600/30">
                        <Shield className="w-3 h-3 text-blue-600" /> AES-256 <ChevronRight className="w-4 h-4 opacity-50" />
                    </div>
                    ...
                    <SignedIn>
                        <div className="flex items-center gap-6">
                            <Link href="/dashboard/schedule" className="text-xs font-black uppercase tracking-widest text-gray-500 hover:text-blue-600 transition-colors">
                                Schedule
                            </Link>
                            <Link href="/dashboard" className="h-14 px-8 bg-gray-900 dark:bg-white text-white dark:text-black rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center gap-3">
                            ...
                            <UserButton
                                ...
                                appearance={{
                                    elements: {
                                        avatarBox: "w-12 h-12 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm"
                                    }
                                }}
                            />
                        </div>
