      ...
      >
        ...
        <div className="relative flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.3em] opacity-70">G-Pilot Mission</div>
              <div className="font-mono text-sm opacity-90">{missionId.slice(0, 12)}</div>
            </div>
          </div>

          {qualityScore !== undefined && (
            <div className="text-right">
              <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Quality Score</div>
        ...
        <div className="relative space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-white/20">
            <div>
              <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Date</div>
              <div className="font-semibold">{formattedDate}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Time</div>
              <div className="font-semibold">{formattedTime} AEST</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Credits Used</div>
              <div className="font-semibold">{creditsUsed} PTS</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-widest opacity-70 mb-1">Agents</div>
        ...
        <div className="relative mt-8 pt-6 border-t border-white/20 flex items-center justify-between">
          <div className="text-xs opacity-70">Verified by G-Pilot AI Orchestration Platform</div>
          <div className="text-xs font-mono opacity-50">#{missionId.slice(-8).toUpperCase()}</div>
        </div>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 text-left">
        <div className="text-sm font-semibold text-gray-900 dark:text-white">Mission Complete</div>
