      ...
      {metrics.map((m, idx) => (
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div
              className={`p-3 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 ${m.color}`}
            >
          ...
          <div className="space-y-1">
            ...
            <p className="text-4xl font-black italic tracking-tighter text-gray-900 dark:text-white leading-none capitalize">
              {m.value}
            </p>
          </div>
        </motion.div>
