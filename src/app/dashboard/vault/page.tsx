...
import { Shield, Lock, Key, Edit3, Trash2, CheckCircle2, AlertCircle, Loader2, ArrowLeft, Cpu, Globe, Eye, EyeOff, ShoppingBag, MessageSquare, Twitter, Linkedin } from "lucide-react";
            ...
            <main className="pt-32 px-6 pb-24 max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                    <header className="space-y-6">
                        <Link href="/dashboard" className="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 transition-colors text-xs font-black uppercase tracking-widest">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em] mt-2">Personal Key Management & Encryption</p>
                            </div>
                        </div>
                    </header>
                    <motion.div
                ...
                <div className="grid grid-cols-1 gap-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 rounded-[2.5rem] bg-gray-50 dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 flex items-center gap-6 shadow-sm">
                        ...
                        <div className="relative z-10 space-y-12">
                            <div className="flex items-center justify-between">
                                <div className="space-y-4">
                                    <h3 className="text-4xl font-black italic uppercase tracking-tighter dark:text-white leading-none underline decoration-blue-600/30 underline-offset-8">Secure Uplink Hub</h3>
                                    <p className="text-gray-500 font-medium text-lg">Initialize your secure mission connections. All data is ephemeral and encrypted.</p>
                                </div>
                                {!isEditing && (
                                    <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4 md:col-span-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Primary Workspace Domain</label>
                                ...
                                {/* Google Key */}
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Gemini-3 API Key</label>
                                    <div className="relative">
                                        ...
                                        />
                                        <button onClick={() => toggleVisibility('gemini')} className="absolute right-6 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 transition-colors">
                                            {showKey['gemini'] ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                                        </button>
                                    </div>
                                </div>
                                ...
                                {/* Shopify Key */}
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Shopify Access Token</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-20 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl pl-16 pr-16 text-xl font-mono focus:outline-none focus:border-blue-600 transition-colors disabled:opacity-50"
                                        />
                                        <button onClick={() => toggleVisibility('shopify')} className="absolute right-6 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 transition-colors">
                                            {showKey['shopify'] ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                                        </button>
                                    </div>
                                </div>
                                ...
                                {/* Reddit Key */}
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Reddit Scout Key</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-20 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl pl-16 pr-16 text-xl font-mono focus:outline-none focus:border-blue-600 transition-colors disabled:opacity-50"
                                        />
                                        <button onClick={() => toggleVisibility('reddit')} className="absolute right-6 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 transition-colors">
                                            {showKey['reddit'] ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                                        </button>
                                    </div>
                                </div>
                                ...
                                {/* X/Twitter Key */}
                                <div className="space-y-4">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">X (Twitter) Uplink</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-20 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl pl-16 pr-16 text-xl font-mono focus:outline-none focus:border-blue-600 transition-colors disabled:opacity-50"
                                        />
                                        <button onClick={() => toggleVisibility('x')} className="absolute right-6 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 transition-colors">
                                ...
                                {/* LinkedIn Key */}
                                <div className="space-y-4 md:col-span-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">LinkedIn Authority Token</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-20 bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-2xl pl-16 pr-16 text-xl font-mono focus:outline-none focus:border-blue-600 transition-colors disabled:opacity-50"
                                        />
                                        <button onClick={() => toggleVisibility('linkedin')} className="absolute right-6 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 transition-colors">
                                            {showKey['linkedin'] ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                                        </button>
                                    </div>
                                </div>
                                ...
                                {isEditing && (
                                    <div className="flex gap-4 pt-10 md:col-span-2">
                                        ...
                                        >
                                            {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : <>Seal & Encrypt Hub <Shield className="w-6 h-6" /></>}
                                        </button>
                                        <button
                    ...
                    <AnimatePresence>
                        {isSuccess && (
                            ...
                            >
                                ...
                                <div>
                                    <div className="text-xs font-black uppercase tracking-[0.2em] opacity-80">Encryption Protocol Finalized</div>
                                    <div className="text-3xl font-black italic uppercase tracking-tighter leading-none">Vault Synced Successfully.</div>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <div className="p-12 rounded-[4rem] bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100/50 dark:border-blue-800/20 flex gap-10 items-start">
                        ...
                        <div className="space-y-4">
                            <h4 className="text-2xl font-black italic uppercase tracking-tighter dark:text-white leading-none">Global Sovereignty Protocol AD-32</h4>
                            <p className="text-gray-500 dark:text-gray-400 text-lg font-medium leading-relaxed">
                                G-Pilot never stores your raw API keys. Every transmission is encapsulated via AES-256-GCM and only decrypted within ephemeral mission runtimes. We act as a secure infrastructure proxy only.
                            </p>
                        </div>
                    </div>
