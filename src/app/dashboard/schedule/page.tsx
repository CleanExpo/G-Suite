          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center gap-2 text-[10px] font-black text-emerald-500 uppercase tracking-widest">
                <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" /> Sector Sync:
                Active
              </div>
            </div>
          ...
          <div className="flex flex-col items-end gap-6">
            ...
            <div className="hidden lg:flex gap-2">
              {[18, 19, 20, 21].map((day) => (
                <div
                  key={day}
                  className={`w-14 h-16 rounded-2xl flex flex-col items-center justify-center border transition-all ${day === 18 ? 'bg-blue-600 border-blue-500 text-white shadow-xl shadow-blue-600/20' : 'bg-white dark:bg-[#161b22] border-gray-100 dark:border-white/10 text-gray-400 opacity-40'}`}
                >
              ...
              <div key={col.id} className="space-y-8">
                <div className="flex items-center justify-between px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-black italic uppercase tracking-tighter text-2xl text-gray-900 dark:text-white">
                      {col.label}
                    </h3>
                  </div>
                  ...
                  <AnimatePresence mode="popLayout">
                    {colTasks.map((task) => (
                      ...
                      >
                        ...
                        <h4 className="text-xl font-black italic uppercase tracking-tighter text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 transition-colors">
                          {task.title}
                        </h4>
                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed line-clamp-2 mb-6">
                          {task.description || 'Initialize mission parameters to begin execution.'}
                        </p>
