...
import { Clock, Tag, ChevronRight, Share2, BookOpen, Search, Filter, Sparkles, Target } from "lucide-react";
            ...
            <main className="pt-32 px-6 max-w-7xl mx-auto">
                <header className="mb-32 space-y-8">
                    ...
                    <p className="text-2xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium max-w-3xl">
                        A tactical dossier on autonomous agent strategy, infrastructure sovereignty,
                        and the future of Gemini-powered orchestration. Grounded in live market telemetry.
                    </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center rounded-[5rem] bg-gray-50/50 dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 p-12 lg:p-20 overflow-hidden relative shadow-sm hover:shadow-2xl transition-all">
                        ...
                        <div className="space-y-8 relative z-10">
                            ...
                            <h2 className="text-4xl lg:text-7xl font-black italic uppercase tracking-tighter leading-none text-gray-900 dark:text-white group-hover:text-blue-600 transition-colors">
                                Scaling To <br />One Million Agents.
                            </h2>
                            ...
                            <div className="space-y-4 px-4">
                                ...
                                <div className="pt-6 flex items-center justify-between">
                                    <div className="flex items-center gap-3 font-black text-xs uppercase tracking-widest text-gray-900 dark:text-white">
                                        Read Report <ChevronRight className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
                                    </div>
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center space-y-10 max-w-2xl mx-auto">
                        ...
                        <h2 className="text-4xl lg:text-7xl font-black italic tracking-tighter uppercase leading-tight">Join the <br />G-Pilot Protocol.</h2>
                        <p className="text-xl text-gray-400 font-medium leading-relaxed">Weekly tactical syncs on the state of autonomous agency delivered directly to your secure Uplink.</p>
                        ...
                        <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Encrypted Transmission · Zero-Spam Sovereign</span>
                    </div>
                </motion.section>
            </main>
        </div>
