    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Analytics & Attribution</h1>
              ...
              {channels.map((channel, idx) => (
                <div key={idx} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    ...
                    <span className="text-green-400">{formatNumber(channel.conversions)} conv</span>
                    <span className="text-yellow-400">{formatCurrency(channel.revenue)}</span>
                  </div>
                </div>
              ))}
            </div>
