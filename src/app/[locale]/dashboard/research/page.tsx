      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <header className="mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl">
            Perform high-fidelity market analysis and competitive intelligence using Gemini 2.0 with
          ...
          <div className="lg:col-span-4 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {focusAreas.map((area, idx) => (
                      ...
                      >
                        {area}
                        <button onClick={() => removeFocus(idx)} className="hover:text-white">
                          ×
                        </button>
                      </span>
                    ))}
            ...
            <div className="bg-[#141417] border border-white/5 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {['SaaS Trends 2026', 'Competitor Audit: Stripe', 'Veo 3.1 Use Cases'].map(
                  (item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-2 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/5 transition-all cursor-pointer group"
                    >
              ...
              {loading ? (
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-sm">
                    Scanning multiple sources, analyzing market vectors, and synthesizing a
                    specialized report...
                  </p>
                  ...
                  <div className="p-4 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-xs text-gray-500">
                        Depth:{' '}
                        <span className="text-gray-300 capitalize">{researchResult.topic}</span>
                      </span>
                    </div>
                ...
                <div className="h-full flex flex-col items-center justify-center bg-[#141417] border border-white/5 border-dashed rounded-2xl p-12 text-center">
                  ...
                  <p className="text-gray-400 max-w-sm">
                    Configure your research objective on the left to start a high-fidelity
