                ...
                <header className="mb-12 flex items-center justify-between">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500">G-Pilot Operative</span>
                        </div>
                        <h1 className="text-5xl font-black italic tracking-tighter">
                            MISSION <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-400 to-purple-500 underline decoration-blue-500/20 underline-offset-8">ARCHITECT</span>
                        </h1>
                    </div>
                    ...
                    <div className="hidden lg:flex items-center gap-6 border border-white/5 bg-white/[0.02] backdrop-blur-xl px-6 py-3 rounded-2xl">
                        <div className="flex flex-col items-end">
                            <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Sovereign Tier</span>
                        ...
                        <AnimatePresence mode="wait">
                                ...
                                >
                                    <div className="bg-white/[0.03] border border-white/5 rounded-3xl p-8 backdrop-blur-3xl shadow-2xl">
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                <label className="text-xs font-black text-gray-500 uppercase tracking-widest mb-3 block">What is the payload?</label>
                                                <textarea
                                                    value={mission}
                                ...
                                >
                                    <div className="bg-white/[0.03] border border-white/5 rounded-3xl p-8 backdrop-blur-3xl">
                                        ...
                                        <div className="space-y-8">
                                            <div>
                                                <label className="text-xs font-black text-gray-500 uppercase tracking-widest mb-4 block">Deployment Platforms</label>
                                                <div className="grid grid-cols-3 gap-3">
                                                    {['LinkedIn', 'Instagram', 'Twitter', 'Google Ads', 'Reddit', 'Email'].map(p => (
                                                        <button
                                                            key={p}
                                            ...
                                            <div>
                                                <label className="text-xs font-black text-gray-500 uppercase tracking-widest mb-4 block">Target Demographic</label>
                                                <input
                                                    value={audience}
                                    ...
                                    <div className="flex gap-4">
                                        <button onClick={() => setActiveStep('objective')} className="flex-1 bg-white/5 border border-white/10 py-5 rounded-2xl font-bold hover:bg-white/10 transition-all">BACK</button>
                                        <button
                            ...
                            {activeStep === 'execution' && (
                                ...
                                >
                                    ...
                                    <h2 className="text-4xl font-black italic tracking-tighter mb-4">SEQUENCING MISSION</h2>
                                    <p className="text-gray-500 max-w-md mx-auto mb-12">
                                        The G-Pilot Overseer is synchronizing with the Marketing Strategist. Market intelligence is being extracted via Jina AI...
                                    </p>
                                    ...
                                    <div className="w-full max-w-lg space-y-4 text-left">
                                        ...
                                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                                            ...
                                            <span className="text-[10px] font-mono text-blue-500 underline animate-pulse">ACTIVE</span>
                                        </div>
                        ...
                        <div className="bg-[#14151a] border border-white/5 rounded-3xl p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-4 bg-white/[0.02] rounded-2xl">
                                    ...
                                    <div className="text-xl font-black">124 <span className="text-xs text-blue-500">PTS</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 bg-gradient-to-br from-blue-600/20 via-transparent to-transparent border border-blue-500/20 rounded-3xl relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <p className="text-[10px] text-gray-500 leading-relaxed mb-4">
                                    All campaign assets are generated in a Sovereign execution environment. Keys never leave the Vault.
                                </p>
                                <button className="text-[10px] font-black underline uppercase tracking-widest text-blue-400">View Policy</button>
                            </div>
