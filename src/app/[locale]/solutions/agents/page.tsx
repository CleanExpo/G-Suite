    ...
    <div className="min-h-screen bg-white dark:bg-[#0b0e14] transition-colors overflow-x-hidden font-sans">
      ...
      <main className="pt-32 px-6 pb-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <p className="text-2xl text-gray-600 dark:text-gray-400 italic font-medium leading-relaxed max-w-lg">
              "Manual prompting is a relic of the past. The G-Pilot era is defined by missions,
              objectives, and autonomous fleet synchronization."
            </p>
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              ...
              <div className="flex items-center gap-3 px-6 py-4 rounded-[1.5rem] bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 opacity-60">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 pt-0.5">
        ...
        <div className="mt-40 grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            {
              title: 'Recursive Correction',
              desc: 'Agents autonomously detect failures in API responses or data structures, iterating logic until the mission goal is secured.',
              icon: Zap,
            },
            {
              title: 'Long-Context Reasoning',
              desc: 'Utilizing massive 1.5M+ token windows to ingest entire codebases or research volumes before executing a command.',
              icon: Search,
            },
            {
              title: 'Coordinate Swarms',
              desc: 'Synchronize multiple agents that share persistent state and mission outputs, acting as a single, multi-modal unit.',
              icon: Users,
            },
          ].map((feature, i) => (
            <motion.div
        ...
        <section className="mt-40 p-20 rounded-[5rem] bg-gray-900 text-white relative overflow-hidden text-center group">
          ...
          <div className="relative z-10 space-y-10 max-w-3xl mx-auto">
            <h2 className="text-5xl lg:text-8xl font-black italic tracking-tighter uppercase leading-[0.75]">
              Experience <br />
              Fleet Sovereignty.
            </h2>
            <p className="text-xl text-gray-400 font-medium">
              Deploy your first vanguard agent today and command the unknown with G-Pilot.
            </p>
