...
import { ArrowRight, Globe, Lock, Check, Loader2, Link as LinkIcon, Shield, Laptop, Zap, Cpu } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#0b0e14] flex items-center justify-center p-6 transition-colors">
            ...
            <div className="fixed top-12 left-1/2 -translate-x-1/2 flex items-center gap-3">
                <div className="relative w-10 h-10 overflow-hidden rounded-full border dark:border-white/10 shadow-sm">
                    ...
                    <Image src="/logo-dark.png" alt="G-Pilot" fill className="object-cover hidden dark:block" />
                </div>
                <div className="flex flex-col">
                    <span className="font-bold text-xl text-gray-900 dark:text-white tracking-tight leading-none uppercase italic">G-Pilot</span>
                    <span className="text-[10px] uppercase tracking-widest text-blue-600 font-bold">Secure Onboarding</span>
                </div>
            </div>
                ...
                <AnimatePresence mode="wait">
                    {step === 1 ? (
                        ...
                        >
                            ...
                            <div>
                                <h2 className="text-4xl font-black italic tracking-tighter uppercase dark:text-white leading-none mb-4">Establish <br />Frequency.</h2>
                                <p className="text-gray-600 dark:text-gray-400 font-medium">Provide your workspace domain. G-Pilot will autonomously extract brand vectors for agent alignment.</p>
                            </div>
                        ...
                        >
                            ...
                            <div>
                                <h2 className="text-4xl font-black italic tracking-tighter uppercase dark:text-white leading-none mb-4">Vault <br />Verification.</h2>
                                <p className="text-gray-600 dark:text-gray-400 font-medium">G-Pilot requires Gemini-3 API access. Your key is AES-256 encrypted and stored in the secure bridge layer.</p>
                            </div>
                            ...
                            >
                                {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : <>Complete Handshake <Cpu className="w-6 h-6" /></>}
                            </button>
                        </motion.div>
                    )}
                </AnimatePresence>
            ...
            <div className="fixed bottom-12 flex gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">
                <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-600" /> SOC2 Verified</div>
                <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-600" /> AES-256 Active</div>
            </div>
