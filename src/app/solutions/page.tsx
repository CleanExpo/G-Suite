            ...
            <main className="pt-32 px-6 pb-24 max-w-7xl mx-auto">
                <header className="mb-32 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
                        Whether you are a solo-founder or a global enterprise, G-Pilot provides the blueprints to scale your efficiency with agentic AI.
                    </p>
                </header>

                <div className="space-y-32">
                    {solutions.map((solution, i) => (
                        <div key={i} id={`solution-block-${i}`} className={`flex flex-col ${i % 2 !== 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-20 items-center group`}>
                            ...
                            >
                                <div className={`aspect-video rounded-[4rem] relative overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.1)] border border-gray-100 dark:border-white/5`}>
                                    <Image
                                        src={[
                            ...
                            <div className="flex-1 space-y-8">
                                ...
                                <ul className="space-y-4">
                                    {["Scalable Architecture", "Native Google Integration", "Vault-grade Security"].map((item, idx) => (
                                        <li key={idx} className="flex items-center gap-3 text-gray-900 dark:text-gray-300 font-black uppercase text-[10px] tracking-widest">
