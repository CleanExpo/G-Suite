...
import { ArrowRight, MessageSquare, TrendingUp, Zap, Globe, Share2, Target, BarChart3, Cpu } from "lucide-react";
        ...
        <div className="min-h-screen bg-white dark:bg-[#0b0e14] transition-colors font-sans overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-10">
                        ...
                        <p className="text-2xl text-gray-600 dark:text-gray-400 font-medium leading-relaxed max-w-xl">
                            We don't do 'marketing'. We orchestrate algorithm-aligned dominance across Google, Reddit, and X using autonomous LLM-native agents.
                        </p>
                    ...
                    <div className="relative aspect-square rounded-[4rem] overflow-hidden border border-gray-100 dark:border-white/5 shadow-2xl">
                        <Image src="/marketing_campaign_dashboard_preview.png" alt="Marketing Results" fill className="object-cover" />
                    </div>
                </div>
            </section>
            ...
            <section className="py-40 bg-gray-50/50 dark:bg-[#0d1017]">
                <div className="max-w-7xl mx-auto text-center mb-24">
                    ...
                    <p className="text-gray-500 font-medium text-xl mt-6">Live mission data demonstrating $12k+ value delivery per cycle.</p>
                </div>
                <MissionShowcase />
            </section>
                ...
                <div className="max-w-7xl mx-auto space-y-32">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        {[
                            ...
                            <div key={i} className="p-12 rounded-[3.5rem] bg-white dark:bg-[#161b22] border border-gray-100 dark:border-white/5 shadow-sm space-y-8 group">
                                <div className={`w-16 h-16 rounded-2xl bg-gray-50 dark:bg-white/5 flex items-center justify-center border border-gray-100 dark:border-white/5 ${node.color}`}>
                                    <node.icon className="w-8 h-8" />
                                </div>
                                <h3 className="text-3xl font-black italic uppercase tracking-tighter dark:text-white leading-none">{node.title}</h3>
                                <p className="text-gray-500 dark:text-gray-400 font-medium leading-relaxed">{node.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-40 px-6 bg-blue-600 text-white rounded-t-[5rem]">
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-12">
                    ...
                    <div className="text-[10px] font-black uppercase tracking-[0.5em] opacity-60">Sovereign Encryption Active · G-Pilot Mesh v9.42</div>
                </div>
            </section>
        </div>
    );
