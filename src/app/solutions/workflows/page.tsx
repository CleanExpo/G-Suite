...
import { Workflow, GitBranch, Layers, Repeat, ShieldCheck, Zap, ArrowRight, Target, Activity, Cpu } from "lucide-react";
            ...
            <main className="pt-32 px-6 pb-24 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                    ...
                    <div className="space-y-16 pt-12">
                        {[
                            { title: "Dynamic Branching", desc: "Workflows that pivot based on live intelligence telemetry. No more rigid linear sequences or binary triggers.", icon: GitBranch },
                            { title: "Persistent History", desc: "Every mission step is recorded in our Prisma-backed high-performance ledger for full auditing and cost transparency.", icon: Repeat },
                            { title: "Gemini Edge Reasoning", desc: "Native integration with the newest Gemini-3 models allows for reasoning that exceeds standard agentic benchmarks.", icon: Zap }
                        ].map((feature, i) => (
                            <motion.div
                                key={i}
                ...
                <div className="mt-40 p-12 rounded-[4rem] bg-gray-50/50 dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 flex flex-col lg:flex-row items-center justify-between gap-12">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="space-y-1">
                            <h4 className="text-2xl font-black italic uppercase tracking-tighter dark:text-white">Orchestration Substrate</h4>
                            <p className="text-gray-500 font-medium">Powering 10k+ concurrent mission branches per sector.</p>
                        </div>
                    </div>
