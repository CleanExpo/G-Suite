...
const AbilityCard = ({ title, description, icon: Icon, category, howTo, demoPrompt }: AbilityCardProps) => (
    <motion.div
        whileHover={{ y: -10 }}
    ...
    >
        ...
        <div className="relative z-10 space-y-6">
            ...
            <div>
                <h3 className="text-2xl font-black italic tracking-tighter mb-4 text-gray-900 dark:text-white uppercase group-hover:text-blue-600 transition-colors">{title}</h3>
            ...
            <div className="pt-6 border-t border-gray-50 dark:border-white/5 space-y-4">
                <div className="space-y-1">
                    <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Tactical Use:</span>
                ...
                <div className="bg-gray-50 dark:bg-black/20 p-4 rounded-2xl border border-gray-100 dark:border-white/5">
                    <span className="text-[10px] font-black uppercase tracking-widest text-blue-600 mb-2 block">Demo Command:</span>
    ...
    const abilities = [
        {
            ...
            description: "Generate ultra-realistic 3D isometric brand assets and architectural renders. Designed for high-converting marketing materials.",
            icon: ImageIcon,
            howTo: "Best for creating unique visuals that stock photography cannot provide.",
            demoPrompt: "Create a 3D isometric render of a floating server lab with blue neon core, cinematic lighting, 8k resolution."
        },
        {
            category: "Motion",
            title: "Cinematic Video",
            description: "Orchestrate motion graphics and cinematic loops tailored to your brand's kinetic identity. Powered by G-Pilot's motion engine.",
            icon: Video,
            howTo: "Ideal for background loops or feature announcement snippets on social media.",
            demoPrompt: "Generate a slow-motion cinematic sweep of a high-tech cockpit with glowing blue sensors and nebula background."
        },
        {
            category: "Intelligence",
            title: "Market Intel Reports",
            description: "Deep research swarms that crawl the web, Grounding results with Gemini, to produce comprehensive strategic dossiers.",
            icon: Search,
            howTo: "Use this to stay ahead of competitors or analyze market shifts in real-time.",
            demoPrompt: "Run a deep research report on the current state of autonomous agent infrastructure and G-Pilot's positioning."
        },
        {
            category: "Creative",
            title: "Slide Deck Builder",
            description: "Automated storyboard-to-slide generation. G-Pilot builds the outline, exports to Google Slides, and fills content via LLM reasoning.",
            icon: FileText,
            howTo: "Rapidly prototype investment decks or internal strategy presentations.",
            demoPrompt: "Create a 5-slide pitch deck for G-Pilot's 2026 expansion into the decentralized compute market."
        },
        {
            category: "Sovereignty",
            title: "Vault Proxy",
            description: "Secure AES-256 handling of sensitive Google API and OAuth keys. Mission data is ephemeral, ensuring absolute privacy.",
            icon: Lock,
            howTo: "Crucial for enterprise compliance and handling sensitive customer data safely.",
            demoPrompt: "Securely bridge my Google AI Studio key and scrape brand assets from g-pilot.app for a new mission."
        },
        {
            category: "Orchestration",
            title: "Crawl & Vectorize",
            description: "Autonomous brand vector extraction. G-Pilot reads any URL to determine brand voice, colors, and logos automatically.",
            icon: Globe,
            howTo: "Uniformity across all agent outputs, ensuring your AI sounds and looks like you.",
            demoPrompt: "Crawl g-pilot.app and extract the brand identity vectors for a social media campaign."
        }
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                    <header className="space-y-8">
                        ...
                        <p className="text-2xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
                            A definitive tactical library of G-Pilot's capabilities.
                            Each module is a battle-tested agent workflow refined for the Gemini-3 engine.
                        </p>
                    </header>
                    <motion.div
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-8">
                            <h2 className="text-4xl lg:text-6xl font-black italic tracking-tighter uppercase leading-none">Execute on the <br />Edge.</h2>
                            <p className="text-xl text-gray-400 font-medium">Ready to see G-Pilot in action? Load the Codex into the command center and launch your first mission today.</p>
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-8 w-full">
                            {[
                                ...
                                <div key={i} className="p-8 bg-white/5 rounded-[2rem] border border-white/5 backdrop-blur-md">
                                    <div className="text-3xl font-black italic">{stat.val}</div>
                                    <div className="text-[10px] uppercase font-bold tracking-widest text-blue-500 mt-1">{stat.label}</div>
                                </div>
                            ))}
                        </div>
                    </div>
