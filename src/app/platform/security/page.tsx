...
import { Shield, Lock, Fingerprint, Key, FileWarning, EyeOff, Target, ArrowRight } from "lucide-react";
            ...
            <main className="pt-32 px-6 pb-24 max-w-7xl mx-auto">
                <header className="mb-32 space-y-8">
                    ...
                    <p className="text-2xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium max-w-3xl">
                        At G-Pilot, privacy is the substrate. We've engineered an infrastructure where autonomous agents execute in hermetically sealed sandboxes. Data is ephemeral. Logic is absolute.
                    </p>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {[
                        { title: "AES-256 Encryption", desc: "All sensitive API keys and brand data are encrypted at rest using industry-standard AES-256-GCM, stored in isolated regional vaults.", icon: Lock },
                        { title: "Ephemeral Runtimes", desc: "Mission runtimes are spun up on-demand and purged instantly upon completion. Zero persistent traces of your intellectual property.", icon: EyeOff },
                        { title: "Key Ownership", desc: "Maintain full command of your Google and social API keys. G-Pilot acts as a secure proxy, never storing raw credentials in human-readable form.", icon: Key },
                        { title: "SOC2 Ready", desc: "Our data handling protocols are natively built to align with the strictest SOC2 Type II and ISO 27001 compliance frameworks.", icon: Shield },
                        { title: "MFA Authentication", desc: "Dashboard access requires multi-factor biometric authentication via Clerk, ensuring only authorized commanders launch missions.", icon: Fingerprint },
                        { title: "Kinetic Monitoring", desc: "Real-time AI-powered threat detection monitors for unusual agent behavior or unauthorized uplink attempts across the global hub.", icon: FileWarning }
                    ].map((feature, i) => (
                        <motion.div
                            key={i}
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-black italic tracking-tighter uppercase mb-4 text-gray-900 dark:text-white group-hover:text-blue-600 transition-colors">{feature.title}</h3>
                ...
                <section className="mt-40 p-16 lg:p-24 rounded-[4.5rem] bg-gray-900 text-white relative overflow-hidden group">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-5xl lg:text-7xl font-black italic tracking-tighter uppercase leading-none">Our Data <br />Sovereignty.</h2>
                            <p className="text-xl text-gray-400 font-medium leading-relaxed">
                                G-Pilot does not train on your inputs. We do not sell telemetry.
                                We provide the secure high-performance cockpit; you own the objective logic.
                            </p>
                            <Link href="/privacy">
