...
import { Server, Zap, Cpu, Cloud, Database, Network, Lock, LucideIcon, Activity } from "lucide-react";
...
const StatCard = ({ label, val, icon: Icon }: { label: string, val: string, icon: LucideIcon }) => (
    <div className="p-8 rounded-[2.5rem] bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 group hover:bg-white dark:hover:bg-white/10 transition-all">
        ...
        <div className="text-2xl font-black text-gray-900 dark:text-white font-mono tracking-tighter">{val}</div>
    </div>
);
            ...
            <main className="pt-32 px-6 pb-24 max-w-7xl mx-auto">
                <header className="mb-24 space-y-8">
                    ...
                    <p className="text-2xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium max-w-3xl">
                        Built exclusively on Google's high-performance silicon. G-Pilot orchestrates missions across a distributed matrix of GPUs, ensuring sub-second response times for complex agentic reasoning.
                    </p>
                </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    >
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <h2 className="text-4xl font-black italic uppercase tracking-tighter dark:text-white leading-tight">Google Cloud Native</h2>
                                <p className="text-blue-600 font-bold uppercase text-[10px] tracking-widest mt-1">Architecture Substrate</p>
                            </div>
                        </div>

                        <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium italic">
                            "G-Pilot is not merely hosted; it is architecturally fused with Google Cloud Run.
                            Our core fleet utilizes native GPU acceleration to power multi-modal generation
                    ...
                    <div className="space-y-12">
                        <div className="p-12 rounded-[4rem] bg-gradient-to-br from-gray-900 to-black text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <h3 className="text-3xl font-black italic uppercase tracking-tighter mb-4">Precision Compute</h3>
                            <p className="text-gray-400 text-sm leading-relaxed mb-6 font-medium">
                                Utilizing NVIDIA L4 Tensor Core GPU clusters for the Imagen 3 and Cinematic Video pipelines. Built for speed, scaled for intelligence.
                            </p>
                        ...
                        <div className="p-12 rounded-[4rem] bg-white dark:bg-[#161b22] border border-gray-100 dark:border-white/5 shadow-xl">
                            ...
                            <h3 className="text-3xl font-black italic uppercase tracking-tighter dark:text-white mb-2 underline decoration-purple-600/30 underline-offset-8">AlloyDB.</h3>
                ...
                <section className="mt-40 p-16 lg:p-24 rounded-[5rem] bg-gray-50/50 dark:bg-white/[0.01] border border-gray-100 dark:border-white/5 text-center space-y-12">
                    <div className="max-w-3xl mx-auto space-y-6">
                        <h2 className="text-4xl lg:text-7xl font-black italic tracking-tighter uppercase dark:text-white leading-tight">22 Global Regions. <br />One Command Hub.</h2>
                        <p className="text-xl text-gray-500 font-medium">Your missions execute on the hardware nearest to your users, minimizing latent drag across the global fleet.</p>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {["US-East-1", "EU-West-3", "ASIA-South-1", "AU-SE-1"].map((region, i) => (
                            <div key={i} className="p-8 bg-white dark:bg-black/20 rounded-[2rem] border border-gray-100 dark:border-white/5">
