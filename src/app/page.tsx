...
import { ArrowRight, ShieldCheck, Zap, Globe, Lock, Cpu, Database, Layout, Sparkles, Share2 } from "lucide-react";
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0b0e14] transition-colors selection:bg-blue-100 dark:selection:bg-blue-900 selection:text-blue-900 dark:selection:text-blue-100 font-sans overflow-x-hidden">
            ...
            <section ref={targetRef} className="relative h-screen min-h-[900px] flex items-center justify-center pt-32 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-7xl lg:text-[10rem] font-black tracking-tighter text-gray-900 dark:text-white leading-[0.75] uppercase group font-tactical italic">
                            G-PILOT <br />
                            <span className="text-blue-600 group-hover:text-blue-500 transition-colors font-serif-emphasis normal-case">Core.</span>
                        </h1>

                        <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-400 leading-relaxed font-medium max-w-lg">
                            Deploy high-fidelity <TacticalTicker words={["autonomous", "recursive", "scalable"]} className="text-blue-600 font-bold" /> agent fleets.
                            Built on Google's most advanced reasoning engines,
                            anchored in the <span className="text-gray-900 dark:text-white font-black italic underline decoration-blue-600/30 underline-offset-4">Cloud Run GPU matrix</span>.
                        </p>
                        ...
                        <div className="flex flex-wrap items-center gap-6 pt-4">
                            <SignInButton mode="modal">
                                <button className="h-20 px-12 bg-blue-600 hover:bg-blue-700 text-white rounded-[1.5rem] font-black text-2xl shadow-2xl shadow-blue-600/30 flex items-center gap-4 transition-all hover:scale-105 active:scale-95 group relative overflow-hidden">
                                    ...
                                    Ignite <ArrowRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                                </button>
                            </SignInButton>
                            <Link href="/abilities">
            ...
            <section className="py-24 px-6 border-y border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <h3 className="text-sm font-black uppercase tracking-[0.5em] text-blue-600 dark:text-blue-400">Trusted Partners</h3>
                        <h2 className="text-5xl font-black italic tracking-tighter text-gray-900 dark:text-white uppercase leading-none">
                            Powered By <br /><span className="text-blue-600 font-serif-emphasis normal-case">Vanguard Industry Nodes.</span>
                        </h2>
                        <p className="text-lg text-gray-500 font-medium leading-relaxed">
                            Our architecture is anchored in the world's most robust intelligence ecosystems, ensuring near-zero latency and infinite scalability.
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto space-y-24">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-xl text-gray-500 font-medium max-w-2xl mx-auto">
                            Switch between mission protocols with zero friction. One UI, infinite autonomous depth.
                        </p>
                    </div>
                                        ...
                                        >
                                            <div className="space-y-4">
                                                ...
                                                <div className="h-2 w-full bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                                                    <motion.div initial={{ width: 0 }} whileInView={{ width: "84%" }} className="h-full bg-emerald-500" />
                                                </div>
                                            </div>
                                        </TacticalBox>
                                        <div className="relative aspect-video rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 dark:border-white/5">
                                            <Image src="/social_media_swarm_reddit.png" alt="Social Swarm" fill className="object-cover" />
                                        </div>
                                    </div>
                                )
                            },
                                ...
                                content: (
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                        <div className="space-y-8">
                                            ...
                                            <h2 className="text-5xl font-black italic tracking-tighter text-gray-900 dark:text-white uppercase leading-none">
                                                Simulate Your <br /><span className="text-blue-600 font-serif-emphasis normal-case">Intelligence Flow.</span>
                                            </h2>
                                            <p className="text-lg text-gray-500 font-medium leading-relaxed">
                                                Test your mission parameters against our reasoning engine before deployment. G-Pilot ensures every vector is optimized for maximum result velocity.
                                            </p>
                                        </div>
                                        <MissionSimulator />
                                    </div>
            ...
            <section className="py-40 px-6 bg-white dark:bg-[#0b0e14]">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <p className="text-gray-500 font-medium mt-6 text-xl">Inside the G-Pilot mission ledger. High-value blueprints for market dominance.</p>
                </div>
                <MissionShowcase />
            </section>
