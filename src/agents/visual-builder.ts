...
export class VisualBuilderAgent extends BaseAgent {
    ...
    private readonly model = genAI.getGenerativeModel({
        ...
        systemInstruction: 'You are an AI agent architect. You help users design agent workflows using visual building blocks. Ensure all designs are valid and follow best practices.'
    });
    ...
    private async generateBlueprint(findings: Record<string, unknown>, context: AgentContext): Promise<BuilderResult> {
        try {
            const prompt = `
