...
export class EmailMarketingAgent extends BaseAgent {
  ...
  readonly requiredSkills = ['sendgrid_api', 'mailchimp_api', 'template_engine', 'gemini_3_flash'];
  ...
  private readonly model = genAI.getGenerativeModel({
    ...
    systemInstruction:
      'You are an email marketing specialist. You create compelling email campaigns, optimise for deliverability, and analyse performance metrics. Use Australian English.',
  });
