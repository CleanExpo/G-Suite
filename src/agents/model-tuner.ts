...
export class ModelTunerAgent extends BaseAgent {
    ...
    private readonly model = genAI.getGenerativeModel({
        ...
        systemInstruction: 'You are an ML engineer specialising in model fine-tuning. You manage training pipelines, optimise hyperparameters, and ensure model quality. Use Australian English.'
    });
