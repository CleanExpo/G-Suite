...
export class WhiteLabelAgent extends BaseAgent {
    ...
    private readonly model = genAI.getGenerativeModel({
        ...
        systemInstruction: 'You are a multi-tenant platform architect. You manage white-label deployments, tenant configurations, and platform health monitoring.'
    });
    ...
    private async generatePlatformDashboard(findings: Record<string, unknown>): Promise<PlatformDashboard> {
        try {
            const prompt = `
