...
export class ContentOrchestratorAgent extends BaseAgent {
  ...
  readonly description =
    'Content creation and presentation orchestration with Gemini 3 and Veo 3.1';
  ...
  private readonly model = genAI.getGenerativeModel({
    ...
    systemInstruction:
      'You are a content strategist and creative director. Create compelling narratives and visual stories that captivate audiences.',
  });
