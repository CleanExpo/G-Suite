...
export class VoiceControlAgent extends BaseAgent {
  ...
  private readonly model = genAI.getGenerativeModel({
    ...
    systemInstruction:
      'You are a voice interface assistant. Parse voice commands, detect intent, and provide natural conversational responses. Be concise and helpful.',
  });
  ...
  private async processVoiceSession(
