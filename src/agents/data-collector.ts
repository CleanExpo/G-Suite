...
export class DataCollectorAgent extends BaseAgent {
  ...
  readonly requiredSkills = ['structured_scraper', 'serp_collector', 'data_archive', 'deep_lookup'];
  ...
  private readonly scrapers: Map<string, DomainScraper> = new Map([
    ...
    [
      'amazon',
      {
        domain: 'amazon.com',
        category: 'ecommerce',
        fields: ['title', 'price', 'rating', 'reviews', 'asin'],
        rateLimit: 30,
      },
    ],
    [
      'ebay',
      {
        domain: 'ebay.com',
        category: 'ecommerce',
        fields: ['title', 'price', 'bids', 'seller'],
        rateLimit: 30,
      },
    ],
    [
    ...
    [
      'shopify',
      {
        domain: 'shopify.com',
        category: 'ecommerce',
        fields: ['title', 'price', 'variants', 'images'],
        rateLimit: 60,
      },
    ],
    ...
    [
      'linkedin',
      {
        domain: 'linkedin.com',
        category: 'social',
        fields: ['name', 'title', 'company', 'location', 'skills'],
        rateLimit: 10,
      },
    ],
    [
      'twitter',
      {
        domain: 'twitter.com',
        category: 'social',
        fields: ['handle', 'bio', 'followers', 'tweets'],
        rateLimit: 30,
      },
    ],
    [
      'instagram',
      {
        ...
        category: 'social',
        fields: ['username', 'bio', 'followers', 'posts'],
        rateLimit: 20,
      },
    ],
    [
      'tiktok',
      {
        domain: 'tiktok.com',
        category: 'social',
        fields: ['username', 'bio', 'followers', 'likes'],
        rateLimit: 20,
      },
    ],
    ...
    [
      'google',
      {
        domain: 'google.com',
        category: 'search',
        fields: ['title', 'url', 'snippet', 'position', 'ads'],
        rateLimit: 60,
      },
    ],
    [
    ...
    [
      'yelp',
      {
        domain: 'yelp.com',
        category: 'reviews',
        fields: ['name', 'rating', 'reviews', 'address', 'phone'],
        rateLimit: 20,
      },
    ],
    [
      'tripadvisor',
      {
        ...
        category: 'reviews',
        fields: ['name', 'rating', 'reviews', 'location'],
        rateLimit: 20,
      },
    ],
    [
      'g2',
      {
        domain: 'g2.com',
        category: 'reviews',
        fields: ['product', 'rating', 'reviews', 'category'],
        rateLimit: 30,
      },
    ],
    [
      'trustpilot',
      {
        ...
        category: 'reviews',
        fields: ['company', 'rating', 'reviews', 'score'],
        rateLimit: 30,
      },
    ],
    ...
    [
      'indeed',
      {
        domain: 'indeed.com',
        category: 'jobs',
        fields: ['title', 'company', 'salary', 'location', 'description'],
        rateLimit: 30,
      },
    ],
    [
      'glassdoor',
      {
        ...
        category: 'jobs',
        fields: ['title', 'company', 'salary', 'rating'],
        rateLimit: 20,
      },
    ],
    [
    ...
    [
      'booking',
      {
        domain: 'booking.com',
        category: 'travel',
        fields: ['name', 'rating', 'price', 'location'],
        rateLimit: 20,
      },
    ],
    [
      'expedia',
      {
        domain: 'expedia.com',
        category: 'travel',
        fields: ['name', 'rating', 'price', 'amenities'],
        rateLimit: 20,
      },
    ],
    [
      'kayak',
      {
        domain: 'kayak.com',
        category: 'travel',
        fields: ['airline', 'price', 'duration', 'stops'],
        rateLimit: 30,
      },
    ],
    ...
    [
      'google_news',
      {
        ...
        category: 'news',
        fields: ['title', 'source', 'date', 'snippet'],
        rateLimit: 60,
      },
    ],
    [
      'reuters',
      {
        domain: 'reuters.com',
        category: 'news',
        fields: ['title', 'date', 'content', 'category'],
        rateLimit: 30,
      },
    ],
    [
      'bloomberg',
      {
        ...
        category: 'news',
        fields: ['title', 'date', 'content', 'author'],
        rateLimit: 20,
      },
    ],
  ]);
  ...
  private readonly model = genAI.getGenerativeModel({
    ...
    systemInstruction:
      'You are a data enrichment specialist. Augment and validate structured data.',
  });
   ...
   */
  private async collectFromDomain(scraper: DomainScraper, query: string): Promise<DataFeedItem[]> {
  ...
  private validateData(
    ...
    for (const item of items) {
      ...
      const hasRequiredFields = scraper.fields.every((field) => item.data[field] !== undefined);
    ...
    try {
      for (const step of plan.steps) {
        ...
        if (step.tool === 'structured_scraper') {
          ...
          if (scraper) {
            const items = await this.collectFromDomain(scraper, step.payload.query as string);
