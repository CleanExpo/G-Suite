...
export class GeoMarketingAgent extends BaseAgent {
    ...
    readonly description = 'Generative Engine Optimization agent implementing Synthex Apex Architecture for 2026/27 AI-first marketing';
...
Prioritize factual precision and citation-worthiness over traditional marketing fluff.`
    ...
    private createFallbackPlan(url: string, mission: string): AgentPlan {
        return {
            ...
            reasoning: 'Comprehensive Synthex Apex Architecture GEO audit with citation-first methodology'
        };
    }
            ...
            switch (tool) {
                ...
                case 'gemini_3_flash':
                    return skills.gemini3Flash(userId, payload.prompt as string, {
                        systemInstruction: 'Generate citation-worthy, factually precise content with proper source attribution.',
                        ...payload
                    });
    ...
    private async calculateAuthorityScore(
        ...
        try {
            ...
            return [
                { platform: 'gemini', mentions: 0, citations: 0, sentiment: 'neutral', authorityRank: 5, competitors: [] },
                { platform: 'chatgpt', mentions: 0, citations: 0, sentiment: 'neutral', authorityRank: 5, competitors: [] },
                { platform: 'perplexity', mentions: 0, citations: 0, sentiment: 'neutral', authorityRank: 5, competitors: [] },
                { platform: 'claude', mentions: 0, citations: 0, sentiment: 'neutral', authorityRank: 5, competitors: [] }
            ];
        }
    }
    ...
    private async applyForensicLayer(
        ...
        try {
            ...
            return { passed: true, score: 70, recommendations: ['Unable to analyze - manual review recommended'] };
        }
    }
