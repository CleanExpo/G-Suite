...
export class ContentCalendarAgent extends BaseAgent {
    ...
    private readonly model = genAI.getGenerativeModel({
        ...
        systemInstruction: 'You are a content strategist and editorial calendar manager. You excel at organising content schedules, identifying gaps, and optimising publishing workflows.'
    });
