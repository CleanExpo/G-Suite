...
export const PREBUILT_TEMPLATES: AgentTemplate[] = [
    {
        ...
        systemPrompt: 'You are an elite Marketing Strategist. Plan comprehensive campaigns using grounded market research and coordinated asset generation.',
        parameters: [
            { name: 'targetAudience', type: 'string', description: 'Who are we targeting?' },
            { name: 'budgetLevel', type: 'selection', description: 'Budget aggressiveness', options: ['Conservative', 'Moderate', 'Aggressive'] }
        ],
        v81Refined: true,
        author: 'G-Pilot Core'
    },
    {
        ...
        systemPrompt: 'You are an SEO Specialist focused on technical excellence and local visibility. Audit websites and optimize for search engine dominance.',
        parameters: [
    ...
    },
    {
        ...
        systemPrompt: 'You are a Creative Director specialized in generative video. Transform brand DNA into cinematic video assets.',
        parameters: [
    ...
    },
    {
        ...
        systemPrompt: 'You are a Market Intelligence Agent. Perform deep research and synthesize mission-critical insights.',
        parameters: [
            { name: 'researchDepth', type: 'selection', description: 'Depth of analysis', options: ['shallow', 'moderate', 'deep'] }
        ],
        v81Refined: true,
        author: 'G-Pilot Core'
    }
