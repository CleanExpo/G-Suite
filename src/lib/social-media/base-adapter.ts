...
export abstract class BaseSocialMediaAdapter {
   ...
   */
  abstract validate(content: SocialMediaContent, postType: PostType): ValidationResult;
   ...
   */
  abstract getAnalytics(postId: string, accountId: string): Promise<PostAnalytics | null>;
