...
export class GA4Client {
    ...
    private getMockCampaignReport(startDate: string, endDate: string): CampaignReport {
        const campaigns: CampaignMetrics[] = [
            { campaignId: '1', campaignName: 'Brand Awareness Q1', source: 'google', medium: 'cpc', sessions: 3420, users: 2890, conversions: 89, revenue: 7890.00 },
            { campaignId: '2', campaignName: 'Product Launch', source: 'facebook', medium: 'paid_social', sessions: 2100, users: 1890, conversions: 67, revenue: 5670.00 },
            { campaignId: '3', campaignName: 'Newsletter', source: 'mailchimp', medium: 'email', sessions: 1560, users: 1340, conversions: 45, revenue: 3890.00 },
            { campaignId: '4', campaignName: 'Organic Traffic', source: 'google', medium: 'organic', sessions: 4200, users: 3560, conversions: 112, revenue: 8900.00 },
        ];
    ...
    private getMockChannelPerformance(): ChannelPerformance[] {
        return [
            { channel: 'organic_search', sessions: 4200, users: 3560, conversions: 112, revenue: 8900, assistedConversions: 45, lastClickConversions: 112 },
            { channel: 'paid_search', sessions: 3420, users: 2890, conversions: 89, revenue: 7890, assistedConversions: 34, lastClickConversions: 89 },
            { channel: 'social', sessions: 2100, users: 1890, conversions: 67, revenue: 5670, assistedConversions: 28, lastClickConversions: 67 },
            { channel: 'email', sessions: 1560, users: 1340, conversions: 45, revenue: 3890, assistedConversions: 12, lastClickConversions: 45 },
            { channel: 'direct', sessions: 890, users: 780, conversions: 23, revenue: 1890, assistedConversions: 8, lastClickConversions: 23 },
            { channel: 'referral', sessions: 280, users: 260, conversions: 6, revenue: 210, assistedConversions: 3, lastClickConversions: 6 },
        ];
    }
    ...
    private getMockConversionReport(startDate: string, endDate: string): ConversionReport {
        return {
            dateRange: { startDate, endDate },
            goals: [
                { goalId: 'purchase', goalName: 'Purchase', completions: 234, value: 23400, conversionRate: 2.8 },
                { goalId: 'sign_up', goalName: 'Sign Up', completions: 567, value: 0, conversionRate: 6.8 },
                { goalId: 'generate_lead', goalName: 'Generate Lead', completions: 123, value: 1230, conversionRate: 1.5 },
                { goalId: 'add_to_cart', goalName: 'Add To Cart', completions: 890, value: 0, conversionRate: 10.7 },
            ],
