...
export type LiveIncomingMessage =
    | { setup_complete: {} }
    | { server_content: { model_turn: { parts: { text?: string; inline_data?: { mime_type: string; data: string } }[] }; turn_complete?: boolean; interruption?: boolean } }
...
export type LiveOutgoingMessage =
    | { setup: LiveConfig }
    | { client_content: { turns: { role: 'user'; parts: { text?: string; inline_data?: { mime_type: string; data: string } }[] }[]; turn_complete: boolean } }
