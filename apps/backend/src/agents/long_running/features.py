...
def generate_features_from_spec(spec: str) -> list[dict[str, Any]]:
    """Generate a list of features from a high-level specification.

    This is a template that would be expanded by the InitializerAgent
    using Claude to analyze the spec and generate comprehensive features.

    Args:
        spec: High-level project specification

    Returns:
        List of feature definitions (to be expanded by LLM)
    """
    # This is a placeholder - in practice, the InitializerAgent would
    # use Claude to analyze the spec and generate comprehensive features
    return [
        {
            "id": "basic-setup",
            "category": "functional",
